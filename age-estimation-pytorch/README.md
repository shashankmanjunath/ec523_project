...
## Note by shashankmanjunath:
Credit to GitHub user yu4u for this work. The original repository can be found at
https://github.com/yu4u/age-estimation-pytorch. We have modified the demo.py script for our use.
