...
#  __all__ = ['PSPGenerator']


class PSPGenerator(BaseGenerator):
    ...
    def __init__(self, model_name, opts, logger=None):
        self.opts = opts
        ...
        assert self.gan_type == 'psp_stylegan2'

    def build(self):
        self.model = pSp(self.opts)
    ...
    def synthesize(self,
        ...
        if generate_image:
            ...
            images = self.model(zs, input_code=True)
